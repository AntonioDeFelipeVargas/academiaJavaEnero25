...
public class CalculoFinancieroTest {
	...
	void testCalculoFinancieroMock() {
		when(cfc.calculoExterno(1000000L, 10, 5.0f, (byte) 4)).thenReturn(954453.58);
	...
	void testCalculoFinancieroMockSimple() {
		when(cfc.calculoExterno(10L, 1, 1.0f, (byte) 1)).thenReturn(100.00);
		...
		// Verificamos que se llamó al mock con los argumentos correctos
		verify(cfc).calculoExterno(10L, 1, 1.0f, (byte) 1);
